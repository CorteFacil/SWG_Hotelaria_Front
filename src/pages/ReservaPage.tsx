            ...
            <form onSubmit={handleLoginSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input value={docLogin} onChange={handleDocLoginChange} required placeholder={tipoDocLogin === 'CPF' ? "999.999.999-99" : "Seu Passaporte"}
                  className={`w-full p-4 rounded-xl bg-gray-50 outline-none text-center tracking-widest text-lg uppercase font-bold transition-all border ${
                    formError ? 'border-red-400 focus:ring-red-400/40 text-red-600' : 'border-gray-200 focus:bg-white focus:ring-2 focus:ring-[#EF9B1B]/40 focus:border-[#EF9B1B]'
                  }`} />
          ...
          <div className="bg-white p-8 rounded-[2rem] max-w-md w-full shadow-2xl border border-red-100">
            ...
            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 mb-6">
              ...
              <input
                ...
                className={`w-full p-3 rounded-xl bg-white border outline-none font-bold text-center tracking-widest ${
                  erroCancelamento ? 'border-red-400 text-red-600 focus:ring-2 focus:ring-red-100' : 'border-gray-200 focus:border-[#EF9B1B]'
                }`}
